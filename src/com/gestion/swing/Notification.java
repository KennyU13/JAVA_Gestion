...
public class Notification extends javax.swing.JComponent {
    ...
    //public static enum Type { SUCCESS, INFO, ERROR };
    private String type;

    private Location location;

    public Notification(Frame fram, String type, Location location, String message) {
        this.fram = fram;
        this.type = type;
    ...
    private void init(String message) {
        ...
        if ("SUCCESS".equals(type) ){
            lbIcon.setIcon(new ImageIcon(getClass().getResource("/com/gestion/icon/sucess.png")));
            lbMessage.setText("Succès");
        }else if ("INFO".equals(type)){
            lbIcon.setIcon(new ImageIcon(getClass().getResource("/com/gestion/icon/info.png")));
            lbMessage.setText("Information");
        }else{
            lbIcon.setIcon(new ImageIcon(getClass().getResource("/com/gestion/icon/error.png")));
    ...
    public void paint(Graphics grphcs) {
        ...
        if (null == type) g2.setColor(new Color(240, 52, 53));
        else if(type == "SUCCESS") g2.setColor(new Color(18, 163, 24));
        else if(type == "INFO") g2.setColor(new Color(28, 139, 206));
        else g2.setColor(new Color(240, 52, 53));
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(405, 67));
        setPreferredSize(new java.awt.Dimension(405, 67));

        lbIcon.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/gestion/icon/sucess.png"))); // NOI18N
        ...
        lbMessageText.setFont(new java.awt.Font("Segoe UI Semibold", 1, 12)); // NOI18N
